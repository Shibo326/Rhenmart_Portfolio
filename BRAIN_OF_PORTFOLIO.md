...
- Bio line 01: "Self-taught UI/UX Designer and Bachelor of Science in Information Technology (BSIT) student from the Philippines. 5 years of learning by doing — not from courses, but from competitions, workshops, and real projects..."
- Bio line 02: "My workflow: human research first (interviews, observation, papers), then AI to enhance findings and validate decisions..."
- Bio line 03: "5 competition wins taught me to work fast under pressure. 8 projects taught me to listen to users..."
- CTAs: `HIRE_ME` + `DL_RESUME.PDF`

### Services
- Section badge: `SERVICES.EXE // WHAT_I_DO`
- 4 cards: 
  - UI Design: "Clean, intentional interfaces built with design systems..."
  - UX Research: "User interviews, usability testing, and competitive analysis. I validate design decisions with real data..."
  - Prototyping: "Interactive prototypes in Figma and Framer — from quick wireframes to high-fidelity flows..."
  - Design to Dev: "Clear handoffs, component specs, and direct communication with developers. I speak their language..."
