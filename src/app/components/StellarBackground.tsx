...
export const StellarBackground = memo(function StellarBackground({
  ...
  const counts = useMemo(() => {
    const base = {
      ...
      medium: { stars: 14, bigStars: 3, rings: 2 },
      high:   { stars: 20, bigStars: 4, rings: 2 },
    };
    const s = base[density];
    return reduce ? { stars: Math.floor(s.stars * 0.35), bigStars: 1, rings: 1 } : s;
  }, [density, reduce]);
