...
const SERVICES = [
  {
    Icon: Monitor,
    title: "UI Design",
    desc: "Clean, intentional interfaces built with design systems, component libraries, and attention to visual hierarchy. Every pixel serves a purpose.",
  },
  {
    Icon: Search,
    title: "UX Research",
    desc: "User interviews, usability testing, and competitive analysis. I validate design decisions with real data, not gut feelings.",
  },
  {
    Icon: Smartphone,
    title: "Prototyping",
    desc: "Interactive prototypes in Figma and Framer — from quick wireframes to high-fidelity flows. Fast iteration, real feedback.",
  },
  {
    Icon: Handshake,
    title: "Design to Dev",
    desc: "Clear handoffs, component specs, and direct communication with developers. I speak their language — design that actually ships.",
  },
];
  ...
  return (
    <section id="services" className="relative py-32 bg-[#080808] overflow-hidden">
      ...
      <div
        ...
        style={{ boxShadow: "0 0 200px 100px rgba(255,0,0,0.05)" }}
      />
        ...
        <div className="grid md:grid-cols-12 gap-8 items-end mb-16">
          ...
          >
            <p className="text-[rgba(255,255,255,0.55)] leading-relaxed">
              Research-first design solutions from discovery to implementation. Every project starts with understanding the problem, not jumping to solutions.
            </p>
