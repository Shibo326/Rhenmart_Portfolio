...
// Section id → nav link name mapping
...
export function Navbar() {
  const { enableBackdropBlur } = useAnimationConfig();
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          ...
          <motion.button
            ...
            className="md:hidden text-white p-2 rounded-lg bg-white/5 border border-white/10 relative z-50"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="md:hidden overflow-hidden bg-[#050505]/98 border-b border-white/10 relative z-50"
            >
