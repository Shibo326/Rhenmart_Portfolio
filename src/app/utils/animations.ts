// ─── Device Detection ───────────────────────────────────────────────────────
// NOTE: computed once at module load — use useIsMobile() hook for reactive checks
...
export const hoverGlow = isMobile ? {} : {
  whileHover: { boxShadow: "0 0 30px rgba(255,0,0,0.4)", transition: { duration: 0.3 } },
};

// ─── Scroll-Based Parallax Config ───────────────────────────────────────────
